...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
			...
			.antMatchers("/work/day", "/work/monthstatus").hasAnyRole("EMPLOYEE", "ADMIN")
			.antMatchers("/work/dayadmin", "/work/month").hasAnyRole("ADMIN")
			.antMatchers("/work/my-month").hasAnyRole("EMPLOYEE")
			.antMatchers("/salary/salarycalculate","/salary/salarycheck","/salary/salarybook","/salary/salaryperiod","/salary/national-pension","/salary/health-insurance","/salary/employment-insurance").hasAnyRole("ADMIN")
